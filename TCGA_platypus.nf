...
process annotation {
  ...
  '''
  table_annovar.pl -nastring NA -buildver hg38 --thread !{params.annovar_cpu} --onetranscript -remove -protocol refGene,exac03nontcga,esp6500siv2_all,1000g2015aug_all,gnomad_exome,clinvar_20170905,revel,cosmic80,avsnp147,lib26_all -operation g,f,f,f,f,f,f,f,f,f -otherinfo !{filt} !{params.annovar_db}
